...
class Document
{
	public static function addHeadStuff()
	{
		...
		$options = [
			...
			'disable_background_scrolling' => (int) $params->disable_background_scrolling,
			'disable_on_mobile'            => (int) $params->disable_on_mobile,
			'disable_on_mobile_splash'     => (int) $params->disable_on_mobile_splash,
			'mobile_max_width'             => (int) $params->mobile_max_width,
		...
		RL_Document::script('modals/script.min.js', ($params->media_versioning ? '9.8.2.p' : ''));
