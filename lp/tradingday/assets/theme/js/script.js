        ...
        function videoParser(card) {
            $(card).outerFind('[data-bg-video]').each(function() {
                ...
                if (parsedUrl && (/youtube/g.test(parsedUrl[3]) || /vimeo/g.test(parsedUrl[3]))) {
                    ...
                    if (parsedUrl && /youtube/g.test(parsedUrl[3])) {
                        ...
                        $('<img>').on('load', function() {
                            if (120 === (this.naturalWidth || this.width)) {
                                ...
                                var file = this.src.split('https://mobirise.com/').pop();

                                switch (file) {
                                    case 'maxresdefault.jpg':
                                        this.src = this.src.replace(file, 'sddefault.html');
                                        break;
                                    case 'sddefault.jpg':
                                        this.src = this.src.replace(file, 'hqdefault.html');
                                        break;
                                    default: // image not found
                                        if (isBuilder) {
                                            $img.css('background-image', 'url("images/no-video.html")')
                                                .show();
                                        }
                                }
                            } else {
                        ...
                        request.open('GET.html', 'https://vimeo.com/api/v2/video/' + parsedUrl[6] + '.json', true);
                    ...
                    $img.css('background-image', 'url("images/video-placeholder.html")')
                        .show();
                }
            });
        }
