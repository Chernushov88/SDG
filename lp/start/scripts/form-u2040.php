...
$form = array(
	'subject' => 'Отправка Форма Курс Старт на NYSE',
	...
	'fields' => array(
		'custom_U2053' => array(
			...
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Имя (обязательно)\' не может быть пустым.'
			)
		),
		'Email' => array(
			'order' => 2,
			'type' => 'email',
			'label' => 'Эл. почта (обязательно)',
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Эл. почта (обязательно)\' не может быть пустым.',
				'format' => 'Поле \'Эл. почта (обязательно)\' содержит недействительное сообщение эл. почты.'
			)
		),
		'custom_U2049' => array(
			'order' => 3,
			...
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Телефон (обязательно)\' не может быть пустым.'
			)
		)
	)
);
