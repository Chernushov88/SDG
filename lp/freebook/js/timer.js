(function() {
    ...
    var _f = function(_k) { var l = new MegaTimer(_id, { "view": [0, 1, 1, 1], "type": { "currentType": "3", "params": { "weekdays": [1, 1, 1, 1, 1, 1, 1], "usertime": true, "time": "00:00", "tz": -180, "hours": "24", "minutes": "00" } }, "design": { "type": "text", "params": { "number-font-size": "50", "number-font-color": "#147cdb", "separator-margin": "4", "separator-on": true, "separator-text": ":", "text-on": true, "text-font-size": "20", "text-font-color": "#fff" } }, "designId": 1, "theme": "white", "width": 151, "height": 36 }); if (_k != null) l.run(); };
    _t.onload = _f;
