...
class JDocumentRendererHtmlHead extends JDocumentRenderer
{
	...
	public function fetchHead($document)
	{
		...
		{
			$buffer .= $tab . '<meta property="og:description" content="' . htmlspecialchars($documentDescription, ENT_COMPAT, 'UTF-8') . '" />' . $lnEnd;
		...
		{
			$buffer .= $tab . '<link href="' . $link . '" ="' . $linkAtrr['relation'] . '"';
		...
		$defaultJsMimes = array('application/javascript', 'text/x-javascript', 'application/x-javascript');
